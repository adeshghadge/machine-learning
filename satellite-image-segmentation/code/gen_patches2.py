...
def get_patches(x_dict, y_dict, n_patches, sz=160):
    ...
    while total_patches < n_patches:
        ...
        #imgTransformType = random.randint(0,4)
        ...
        #    img = ndimage.rotate(img, angle=45, reshape=False, axes=(1,2))
        #    mask = ndimage.rotate(mask, angle=45, reshape=False, axes=(1,2))
        #elif(imgTransformType == 5):
        #    img = ndimage.rotate(img, angle=135, reshape=False, axes=(1,2))
        #    mask = ndimage.rotate(mask, angle=135, reshape=False, axes=(1,2))
